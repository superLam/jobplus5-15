...
Revision ID: 61e1c8ea5e85
Revises: 
Create Date: 2018-05-05 14:24:22.877390
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('job_experiences', sa.String(length=512), nullable=True),
    sa.Column('edu_experiences', sa.String(length=512), nullable=True),
    sa.Column('project_experiences', sa.String(length=512), nullable=True),
